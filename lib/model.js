...
model.prototype.hydrateModel = function(schema, client, opts, fromObject, state) {
  var model = this.createModel(schema, client, opts);
...
model.prototype.createModel = function(schema, client, opts, state) {
  opts || (opts = {});
  var newInstance = new instance(schema, client, opts, state || states.NEW, this);
  return newInstance;
};
