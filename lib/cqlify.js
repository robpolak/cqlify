...
cqlify.prototype.createConnection = function(options, done) {
...
cqlify.prototype.connect  = function(done) {
  var self = this;
  if(!this._connectionOptions) {
    if (done) {
      done(new Error("Must specify cassandra connection options, please call cqlify.createConnection(options)"));
      return;
    }
    else {
      throw(new Error("Must specify cassandra connection options, please call cqlify.createConnection(options)"));
    }
  }
